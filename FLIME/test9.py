...
def test(img_path):
    ...
    for (i, rect) in enumerate(face_locations):
        ...
        cv2.imwrite("D:/PyCharm 2021.1.3/pycharmproject/Lime-pytorch/result/face_" + str(src_face_num) + ".jpg", detect_face)
    # 人脸对齐操作并保存
    ...
    for faces in faces_aligned:
        ...
        cv2.imwrite("D:/PyCharm 2021.1.3/pycharmproject/Lime-pytorch/result/face_align_" + str(face_num) + ".jpg", faces)
    pass


if __name__ == '__main__':
    test(r"D:\PyCharm 2021.1.3\pycharmproject\Lime-pytorch\crop1\17.jpg")
    print(" SUCCEED !!! ")
    pass
